    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="bg-white dark:bg-[#111a22] border border-gray-200 dark:border-[#324d67] rounded-xl overflow-hidden">
        <div className="p-6 border-b border-gray-200 dark:border-[#324d67] flex justify-between items-center">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white">Pendente de Aprovação <span className="ml-2 bg-primary/20 text-primary text-xs px-2 py-0.5 rounded-full">3</span></h2>
            <div className="flex gap-2">
                <button className="text-sm text-gray-500 hover:text-primary">Marcar tudo como lido</button>
            </div>
        </div>
